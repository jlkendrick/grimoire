...
const SCENES = [
  {
    ...
    lines: [
      ...
      { o: <><T c="#d4a84a">✦</T> <T c="#c0b080">Scrying your grimoire...</T></> },
      { o: <><T c="#6b5a43">  └─</T> <T c="#c0b080">Found </T><T c="#b6c28a">6</T><T c="#c0b080"> python scripts</T></> },
      { o: <><T c="#6b5a43">  └─</T> <T c="#c0b080">Found </T><T c="#b6c28a">2</T><T c="#c0b080"> go sources</T></> },
      { o: <><T c="#d4a84a">✦</T> <T c="#c0b080">Inscribed </T><T c="#b8442c">spell.yaml</T></> },
      { o: "" },
      { o: <T c="#6b5a43">⟡  your spellbook awaits.</T> },
    ],
  },
  {
    ...
    lines: [
      ...
      { o: <><T c="#6b5a43">  ├─</T> <T c="#c0b080">function  </T><T c="#b6c28a">run_daily</T></> },
      { o: <><T c="#6b5a43">  ├─</T> <T c="#c0b080">args      </T><T c="#b6c28a">date:str  accounts:list[str]  dry_run:bool=True</T></> },
      { o: <><T c="#6b5a43">  └─</T> <T c="#c0b080">runtime   </T><T c="#b6c28a">python · pyproject.toml</T></> },
      { o: <><T c="#d4a84a">✦</T> <T c="#c0b080">Bound to spell </T><T c="#b8442c">reconcile</T></> },
    ],
  },
  {
    ...
    lines: [
      ...
      { o: <><T c="#c0b080">⟡ provisioning venv  </T><T c="#6b5a43">[····] </T><T c="#d4a84a">cached</T></> },
      { o: <><T c="#c0b080">⟡ casting spell      </T><T c="#b8442c">reconcile</T></> },
      { o: "" },
